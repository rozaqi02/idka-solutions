...
type Translations = {
  ...
  layanan: {
    ...
    pkg_mobile_app_name: string
    pkg_mobile_app_tagline: string
    pkg_mobile_app_price: string
    pkg_mobile_app_cta: string
    pkg_mobile_app_features: string[]
...
const en: Translations = {
  ...
  layanan: {
    ...
    packagesSectionTag: 'Website Packages',
    packagesSectionTitle: 'Transparent Website Development Pricing',
    packagesSectionSubtitle: 'One-time payment for website creation (no monthly subscription). Scope and revisions agreed upfront.',
    ...
    pkg_starter_features: [
      'Fast 3–5 Business Days Delivery',
      '1 Landing Page',
      ...
      '30-Day Bug-Free Warranty',
      '3–5x Design Revisions',
    ],
    ...
    pkg_business_features: [
      ...
      '3–5 Complete Pages (Home, Services, Portfolio)',
      'Work / Product Showcase Gallery',
      'Interactive Contact Form',
      'Basic Google SEO Optimization',
      'Responsive / Mobile-Friendly',
      'Free SSL Security (HTTPS)',
      '30-Day Bug-Free Warranty',
      '6–9x Revisions (Satisfaction Guarantee)',
    ],
    ...
    pkg_premium_features: [
      ...
      '5–8 Custom & Unique Pages',
      'Exclusive Brand-Aligned Design',
      'CMS (Manage Content & Products Independently)',
      'Product Catalog & Analytics',
      'Speed 90+ Performance Optimization',
      'Free SSL Security (HTTPS)',
      '30-Day Bug-Free Warranty',
      'Unlimited Revisions (Total Satisfaction Guarantee)',
      'Launch Support & User Guide',
    ],

    pkg_mobile_app_name: 'Mobile App',
    pkg_mobile_app_tagline: 'Custom Android & iOS apps (Flutter / React Native)',
    pkg_mobile_app_price: 'From IDR 1,599,000',
    pkg_mobile_app_cta: 'Choose Mobile App',
    pkg_mobile_app_features: [
      '2–4 Weeks Delivery',
      'Cross-Platform Android & iOS (Flutter / React Native)',
      'Database & API Backend Integration',
      'Modern & Responsive Mobile UI/UX Design',
      'Push Notifications & Forms/Catalog',
      'APK Build & App Store Publishing Assistance',
      'SSL & Database Security',
      '30-Day Bug-Free Warranty',
      'Free 3–5x Design & Feature Revisions',
      'Usage Support & Guidance',
    ],
...
const id: Translations = {
  ...
  layanan: {
    ...
    packagesSectionTag: 'Paket Pembuatan Website',
    packagesSectionTitle: 'Harga Pembuatan Website Transparan',
    packagesSectionSubtitle: 'Harga pembuatan website sekali bayar (bukan langganan bulanan). Scope dan revisi disepakati di awal.',
    ...
    pkg_starter_features: [
      'Pengerjaan Cepat 3-5 Hari Kerja',
      '1 Halaman Landing Page',
      'Tombol WhatsApp Instant',
      'Profil Singkat & Katalog Produk',
      'Kontak & Google Maps Location',
      'Responsive / Mobile-Friendly',
      'SSL Keamanan Gratis (HTTPS)',
      'Garansi Bebas Bug 30 Hari',
      '3-5x Revisi Desain',
    ],
    ...
    pkg_business_features: [
      ...
      '3-5 Halaman Lengkap (Beranda, Layanan, Portofolio)',
      'Galeri Karya / Produk',
    ...
    pkg_premium_features: [
      ...
      '5-8 Halaman Kustom & Unik',
      'Desain Eksklusif Sesuai Brand',
      'CMS (Kelola Konten & Produk Mandiri)',
      'Katalog Produk & Analytics',
      'Optimasi Performa Speed 90+',
      'SSL Keamanan Gratis (HTTPS)',
      'Garansi Bebas Bug 30 Hari',
      'Revisi Sepuasnya (Garansi Kepuasan Total)',
      'Dukungan Peluncuran & Panduan',
    ],

    pkg_mobile_app_name: 'Mobile App',
    pkg_mobile_app_tagline: 'Aplikasi Android & iOS kustom (Flutter / React Native)',
    pkg_mobile_app_price: 'Mulai Rp 1.599.000',
    pkg_mobile_app_cta: 'Pilih Mobile App',
    pkg_mobile_app_features: [
      'Pengerjaan 2-4 Minggu',
      'Cross-Platform Android & iOS (Flutter / React Native)',
      'Integrasi Database & API Backend',
      'Desain UI/UX Mobile Modern & Responsive',
      'Push Notification & Form/Katalog',
      'Bantuan Build APK & Publikasi Store',
      'SSL & Keamanan Database',
      'Garansi Bebas Bug 30 Hari',
      'Gratis 3-5x Revisi Desain & Fitur',
      'Dukungan & Pelatihan Penggunaan',
    ],
