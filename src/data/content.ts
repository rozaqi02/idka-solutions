...
export const mobileAppPackage = {
  ...
  tagline: 'Solusi aplikasi mobile kustom dengan Flutter & React Native untuk operasional bisnis, CRM, kasir/POS, katalog digital, hingga MVP startup.',
  price: 'Mulai Rp 1.599.000',
  badge: 'Android & iOS',
  features: [
